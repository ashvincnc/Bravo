...
#        print('slidep',slide_p)
#        print('slide_peep',peep_val)
        data = [0]*4
...
#                print('peep',peep_val)
                if(pressure_va < test_in):
                    test_in = pressure_va
                    self.dataDict["Dpress+"].append(press)
#                    print('t',test_in)
                else:
                    self.dataDict["Dpress+"].append(press)
        ...
        if (graph == 1):
            ...
            press = pressurel[0]
            self.currentPressure_list.append(press)
            ...
            if len(death) > 2:
                ...
                naoh = round(naoh,1)
#            print('deah',naoh)
            if mod_val in [1,2,3,5] and len(death) > 2:
                if(naoh <= 2.8):
 #                   print('aalu out')
                    emergency = 1
                else:
...
#            print('sss',sss)
            ...
            #print('p_done')
            try:
                self.dataDict["o2conc"].append(press)
            except:
                s = 0
...
#                print('pressure',pressure)
              ...
              #  o2s = str(data_m["o2conc"][-1])
                ...
                o2s = "{:.1f}".format(o2)
                if(o2 <= 15):
                    self.laprd.setStyleSheet("color: white;  background-color: red")
