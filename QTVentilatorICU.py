#ventilator project
#  for running icu run the below cmd in terminal
# python3 __program_name__ "icu"
# i had assumed gpio 14 as compressor and gpio 26 as soleniod valve for icu ven
# please double check this gpio are correct and make future duo
# and line 456 make sure wether they are common anode or cathode 
